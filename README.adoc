...
:asset_branch: ci/assets

= https://github.com/[Github]

== Metrics

image::https://raw.githubusercontent.com/{username}/{username}/{asset_branch}/github-metrics.svg[Metrics, float="left", align="center"]
...
:profile_summary_card_url: https://raw.githubusercontent.com/{username}/{username}/{asset_branch}/profile-summary-card-output
...
// zenn start
* Jan 31: https://zenn.dev/tsuyoshicho/articles/2026-01-31-git-alias-with-github-copilot[GitHub Copilotを使う (事例: git のエイリアスの改善)]
* Sep 14: https://zenn.dev/vim_jp/articles/2025-09-15-vim-git-util[Gitのコミットメッセージ上の種別を簡単に変更する]
...
== https://github.com/{username}/meta[Meta] repositories
